...
export function validatePlaceBet(req: Request, _res: Response, next: NextFunction): void {
...
export function validateCashout(req: Request, _res: Response, next: NextFunction): void {
...
export function validateVerify(req: Request, _res: Response, next: NextFunction): void {
